...
def Taskexe():
    ...
    def whatsapp():
        ...
        if 'iron' in name:
            ...
            pywhatkit.sendwhatmsg("+916392383475", msg, hour, minute,)
            ...
            minute = int(takecommand())
            pywhatkit.sendwhatmsg("+919795692340", msg, hour, minute)
            speak("Ok Sir, Sending Whatsapp Message!")
            ...
            speak("Time in Minutes")
            minute = int(takecommand())
            pywhatkit.sendwhatmsg("+919455409420", msg, hour, minute)
            speak("Ok Sir, Sending Whatsapp Message!")
